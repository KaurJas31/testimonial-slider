    ...
    return(
        ...
        p-10 transition-all duration-700 hover:shadow-xl   rounded-md ">
          { <Card review={reviews[index]}/> }
             {/* {
     agr map lgaya to sare cards ajaenge and map function m ( isme return nhi likhna pdta ) but {isme likhna pdta hai }
   
        reviews.map((review)=>(<Card review ={review}></Card>))
        } */}
        <div className="flex text-3xl mt-10 gap-3 text-violet-40 font-bold mx-auto">
